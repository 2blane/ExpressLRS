...
fsm_state_entry_t const main_menu_fsm[] = {
    ...
    {STATE_TELEMETRY, [](){return !firmwareOptions.is_airport && !isMavlinkTransportMode(config.GetLinkMode());}, displayMenuScreen, 20000, value_menu_events, ARRAY_SIZE(value_menu_events)},
    {STATE_SWITCH, [](){return !firmwareOptions.is_airport && !isMavlinkTransportMode(config.GetLinkMode());}, displayMenuScreen, 20000, value_menu_events, ARRAY_SIZE(value_menu_events)},
